...
class seo_picture extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <figure id="attachment_16050" aria-describedby="caption-attachment-16050" style="width: 575px" class="wp-caption aligncenter">

            <img class="cs_image" src="<?php echo $settings['cs_image']['url'] ?>" alt="">

            <figcaption id="caption-attachment-16050" class="wp-caption-text">فست ویلا</figcaption>
...
\Elementor\Plugin::instance()->widgets_manager->register( new seo_picture() );
