...
class favorite_dist_hotel_slider extends \Elementor\Widget_Base {
	public function get_name() {
		return 'favorite_dist_hotel_slider';
	}

	public function get_title() {
		return ' اسلایدر مقصد هتل های محبوب';
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'hotel_ow_SliderQueryCat',
			[

				'label'   => esc_html__( 'انتخاب شهرها', 'jayto' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'options' => $items
			]
		);
		$this->add_control(
			'hotel_ow_CatQueryList',
			[
				'label'       => __( 'انتخاب شهر', 'jayto' ),
				'type'        => \Elementor\Controls_Manager::REPEATER,
				'fields'      => $repeater->get_controls(),
				'title_field' => '{{{hotel_ow_SliderQueryCat}}}',
			]
		);
	...
	private function style_tab() {
		...
		$this->add_group_control(
			...
			[
				'name'     => 'hotel_jt_fav_dist_title_typography',
				'selector' => '{{WRAPPER}} .swiper_header h2',
			]
		);

		$this->add_control(
			'hotel_jt_cat_name1_color',
			[
		...
		$this->add_control(
			'hotel_jjt_cat_name1_color_hover',
			[
		...
		$this->add_control(
			'hotel_jt_cat_name1_color_margin',
			[
		...
		$this->add_control(
			'hotel_jt_cat_name1_color_padding',
			[
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name'     => 'hotel_jt_fav_dist_desc_typography',
				'selector' => '{{WRAPPER}} .swiper_header h5',
			]
		);

		$this->add_control(
			'hotel_jt_fav_dist_desc_color',
			[
				'label'     => esc_html__( 'رنگ عنوان', 'textdomain' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_padding',
			[
				'label'      => esc_html__( 'فاصله داخلی', 'textdomain' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		$this->add_group_control(
			...
			[
				'name'     => 'hotel_jt_fav_dist_item-border',
				'selector' => '{{WRAPPER}} .swiper-slide',
			]
		);
		$this->add_control(
			'hotel_jt_fav_dist_item_radius',
			[
		...
		$this->add_group_control(
			...
			[
				'name'     => 'hotel_jt_fav_dist_item_shadow',
				'selector' => '{{WRAPPER}} .swiper-slide',
			]
		);
		$this->end_controls_section();
		$this->start_controls_section(
			'hotel_jt_fav_dist_desc_link_title_one_style',
			[
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name'     => 'hotel_jt_fav_dist_desc_link_title_one_typography',
				'selector' => '{{WRAPPER}} .city_fav_name span:first-child',
			]
		);
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_one_color',
			[
				'label'     => esc_html__( 'رنگ عنوان', 'textdomain' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_one_hover',
			[
				'label'     => esc_html__( 'رنگ هاورعنوان', 'textdomain' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_one_margin',
			[
				'label'      => esc_html__( 'فاصله', 'textdomain' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_one_padding',
			[
				'label'      => esc_html__( 'فاصله داخلی', 'textdomain' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		$this->end_controls_section();
		$this->start_controls_section(
			'hotel_jt_fav_dist_desc_link_title_tow_style',
			[
		...
		$this->add_group_control(
			\Elementor\Group_Control_Typography::get_type(),
			[
				'name' => 'hotel_jt_fav_dist_desc_link_title_tow__typography',
				'selector' => '{{WRAPPER}} .fc_parent',
			]
		);
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_tow__color',
			[
				'label' => esc_html__( 'رنگ عنوان', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_tow__hover',
			[
				'label' => esc_html__( 'رنگ هاورعنوان', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_tow__margin',
			[
				'label' => esc_html__( 'فاصله', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		$this->add_control(
			'hotel_jt_fav_dist_desc_link_title_tow__padding',
			[
				'label' => esc_html__( 'فاصله داخلی', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
			[
				'name'     => 'hotel_jt_fav_dist_img_border',
		...
		$this->add_group_control(
			\Elementor\Group_Control_Box_Shadow::get_type(),
			[
				'name'     => 'hotel_jt_fav_dist_img_shadow',
				'selector' => '{{WRAPPER}} .city_fav_image',
			]
		);
		$this->add_control(
			'hotel_jt_fav_dist_img_radius',
			[
				'label'      => esc_html__( 'انحنای حاشیه', 'textdomain' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
		...
		$this->add_group_control(
			...
			[
				'name' => 'hotel_jt_fav_dist_img_filters',
				'selector' => '{{WRAPPER}} .city_fav_image',
			]
		);
		$this->end_controls_section();
		$this->start_controls_section(
			'hotel_jt_fav_dist_navi_style',
			[
		...
		$this->add_group_control(
			\Elementor\Group_Control_Border::get_type(),
			[
				'name' => 'hotel_jt_fav_dist_navi_border',
				'selector' => '{{WRAPPER}} .swiper-but-next ,{{WRAPPER}} .swiper-but-prev ',
			]
		);
		$this->add_control(
			'hotel_jt_fav_dist_navi_radius',
			[
				'label'      => esc_html__( 'انحنای حاشیه', 'textdomain' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
	...
	protected function render() {
		...
		$head_title    = $values['hotel_fd_header_title'];
		$head_desc     = $values['hotel_fd_header_desc'];
		$selected_city = $values['hotel_ow_CatQueryList'];
		$city_array    = array();

		if ( $selected_city[0]['hotel_ow_SliderQueryCat'] != '' ) {
			foreach ( $selected_city as $cat ) {

				$city_array[] = $cat['hotel_ow_SliderQueryCat'];
			}
		}
		/** @var TYPE_NAME $al_city */
		$al_city = $this->g_terms( 'city_hotel', 'hotel' );
		...
		<div class="swiper Swiper_hotel">

			<div class="swiper-wrapper">
				<?php
				foreach ( $new_city as $item ) {
					$parent           = get_term_by( "id", $item->parent, "city_hotel" );
					$image            = get_term_meta( $item->term_id, 'term_image', true );
					$parent_term_link = get_term_link( $item->term_id, 'city_hotel' )
		...
		<script>
            var swiper = new Swiper(".Swiper_hotel", {
                slidesPerView: 6.5,
                spaceBetween: 30,
                freeMode: true,
                navigation: {
...
\Elementor\Plugin::instance()->widgets_manager->register( new favorite_dist_hotel_slider() );
