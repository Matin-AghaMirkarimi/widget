                ...
                <div class="request_dates">
                    ...
                    <div id="hdpin" data-resid="<?php echo get_the_ID(); ?>">
                        ...
                        <div class="ds_box">
                            ...
                            <date-picker picker-id="ho_in_picker" from= "<?php echo $form; ?>" <?php if ($in_date != '') echo 'value="'.$in_date.' "'?>   placeholder="انتخاب کنید" mode="single" id="hsearch_date_in_input" name="search_date_in_input" display-format="jYYYY-jMM-jDD" format="jYYYY-jMM-jDD">
                    ...
                    <div id="hdpout" data-resid="<?php echo get_the_ID(); ?>">
                        ...
                        <div class="ds_box">
                            ...
                            <date-picker picker-id="ho_out_picker" from= "<?php echo $form; ?>" <?php if ($in_date != '') echo 'value="'.$out_date.' "'?> from="1401/10/11" placeholder="انتخاب کنید" mode="single" id="hsearch_date_out_input" name="search_date_out_input" display-format="jYYYY-jMM-jDD" format="jYYYY-jMM-jDD">
                                <template #icon></template>
                            </date-picker>
                        </div>
