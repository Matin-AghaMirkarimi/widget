...
class residence_filter extends \Elementor\Widget_Base {
	...
	protected function render() {
        ...
        <div class="sboxes">
            <i class="fad fa-thin fa-people-group"></i>
            <input name="pn_input" class="pn_input fillimp" type="text" placeholder="<?php echo _e('تعداد نفرات','jayto') ?>" >
            <div class="shpn"></div>
        </div>
        ...
        <div class="price_filter pinp">
            <div class="sboxes">
                <i class="fa fa-thin fa-money"></i>
                <input name="price_input"  class="price_input fillimp" type="text" placeholder="<?php echo _e('قیمت برای هر شب','jayto') ?>">
            </div>

            <div class="price_input_box filbox">
                <div class="pri_top">
                    <p class="width100 mt_10"><span class="fz15 fw700 col_gray2"><?php echo _e('قیمت برای هر شب','jayto') ?></span></p>

                    <div>
                        <div class="disjc mt_10 mb10">
                            <span class="range_input_min">50000</span>&nbsp;
                            <span><?php echo _e('تومان','jayto') ?>   <span class="col_gray fz11"> <?php echo _e('تا','jayto') ?> </span></span>
                            &nbsp; <span class="range_input_max">5000000</span>&nbsp;
                            <span><?php echo _e('تومان','jayto') ?> </span>
                        </div>

                          <div class="rsic">
                              <input class="slider" name="min_price" id="min_price" type="range" min="50000" max="5000000" step="1000" value="50000">

                              <input class="slider" name="max_price" id="max_price" type="range" min="50000" max="5000000" step="1000" value="5000000">
        ...
        <div class="people_num pinp">
           ...
           <div class="sboxes">
               ...
               <input name="rp_input" class="rpn_input fillimp" type="text" placeholder="<?php echo _e('تعداد اتاق','jayto') ?>" >
               <div class="show_rn_txt"></div>
           </div>
            <div class="pn_input_box filbox">
                <div class="pnib_top">
                    <figure><i class="fad fa-thin fa-door-open "> </i></figure>
                    <div class="pnib_title">
                ...
                <div class="pnib_bot">
                    ...
                    <span class="arch_room_num_submit subm"><?php echo _e('ثبت تعداد اطاق','jayto') ?></span>
                </div>
            </div>
        </div>
        <script>
