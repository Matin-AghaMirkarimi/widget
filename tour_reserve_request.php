	...
	protected function render() {
        ...
        <div class="reserve_request_box ">
			...
			if ($tour_sans){
                                ...
                                <div class="avtou_itm" data-tif="<?php echo $tour_id . '~' . $ke . '~' . $key ?>">
                                    ...
                                    <div class="d_flex">
                                        ...
                                        <div class="d_flex alignc">
                                            <span class="sans_select_but">انتخاب</span>
                                        </div>
                                    </div>
                                </div>
							<?php }
                ...
                ?>
                 <span class="csans_req_but  " data-tif="<?php echo $tour_id  ?>">درخواست سانس اختصاصی</span>
              ...
              <p class="width100 text-r mbt20 fz14 fw700">درخواست سانس اختصاصی</p>
                ...
                <span class="csans_req_but ">درخواست سانس اختصاصی</span>
		<?php	}
				?>
